...
INSERT INTO `bebidas` VALUES (1,'Agua',1.50),(2,'Limonada',1.80),(3,'Cola',1.80),(4,'Zumo',1.70),(5,'Té con limón',1.80),(6,'Infusión',2.00),(7,'Agua con gas',1.60),(8,'Suizo',4.00),(9,'Cerveza',1.90);
...
CREATE TABLE `churros` (
  ...
  `churroPrecio` decimal(6,2) NOT NULL,
...
-- Dump completed on 2024-10-04 12:04:00
